...
describe UserGroup::MembershipsController do
  ...
  describe 'POST create' do
    it "creates a new membership" do
      ...
      post :create, params: { "membership" => { "user_id" => @user.id, "group_id" => @group.id } }
    ...
    it "should not join unknown group" do
      ...
      post :create, params: { "membership" => { "user_id" => @user.id, "group_id" => 100 } }
  ...
  describe 'DELETE destroy' do
    it "deletes the membership" do
      ...
      delete :destroy, params: { id: @group, "membership" => { "user_id" => @login_user.id, "group_id" => @group.id } }
  ...
  describe 'PUT approve' do
    it "approves a membership" do
      ...
      put :approve, params: { id: @membership }
